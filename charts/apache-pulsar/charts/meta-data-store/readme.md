...
Pulsar creates it's own version of Zookeeper but follows the general principles of Zookeeper administration. There are noticeably less config values
...
| `image.tag`         | Component image tag (immutable tags are recommended) | `latest`                 |
...
| `pulsarEnv.mem`                      | JVM memory settings                                                                                                                  | `-Xms1g -Xmx1g -Dcom.sun.management.jmxremote -Djute.maxbuffer=10485760`  |
...
| Name                                   | Description                                                                                                                                                                                                                                                                              | Value                                                               |
| -------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------- |
| `replicas`                             | The number of meta data stores to deploy                                                                                                                                                                                                                                                 | `3`                                                                 |
| `nonPersistentReplicas`                | Number of non-persistent Meta Data Store nodes. Used as floating Meta Data Store to maintain quorum in AZ failures                                                                                                                                                                       | `0`                                                                 |
...
| `config.admin.enableServer`            | The port at which the admin listens.                                                                                                                                                                                                                                                     | `true`                                                              |
| `config.admin.serverPort`              | The port at which the admin listens.                                                                                                                                                                                                                                                     | `9990`                                                              |
...
| `podDisruptionBudget.minAvailable`            | When enabled the minimum allowed unavailable for matchLabel objects                        | `1`         |
...
| `containerCommand`                      | Override the container image ENTRYPOINT. Leave blank to use image default (if set)                                                                                                            | `["/pulsar/bin/pulsar zookeeper"]` |
...
| Name                           | Description                                                                                                     | Value               |
| ------------------------------ | --------------------------------------------------------------------------------------------------------------- | ------------------- |
| `persistence.mountPath`        | Mount path of Pulsar home                                                                                       | `/pulsar/data`      |
